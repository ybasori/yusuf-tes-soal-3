...
const App = () => {
  return (<div id="app">
      <div className="sidebar">
          ...
          <div className="menu">
              <ul>
                  <li><i className="fas fa-chart-pie"></i> Dashboard</li>
                  <li><i className="fas fa-chart-area"></i>Member Journey</li>
                  <li><i className="fas fa-map-marker-alt"></i>Last Location</li>
                  <li><i className="fas fa-briefcase"></i>Customer</li>
                  <li><i className="fas fa-edit"></i>Task</li>
                  <li><i className="fas fa-sliders-h"></i>Configuration</li>
                  <li><i className="fas fa-list-alt"></i>Report</li>
      ...
      <div className="content">
          ...
          <div className="datatable">
              <button className="btn-orange btn-download">Download Template</button>
          </div>
      </div>
  </div>);
};
